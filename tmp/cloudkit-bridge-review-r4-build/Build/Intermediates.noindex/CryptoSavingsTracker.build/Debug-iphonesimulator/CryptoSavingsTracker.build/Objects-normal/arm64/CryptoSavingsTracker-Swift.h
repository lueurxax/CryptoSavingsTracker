...
#ifndef CRYPTOSAVINGSTRACKER_SWIFT_H
#define CRYPTOSAVINGSTRACKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CryptoSavingsTracker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Cache entry wrapper
SWIFT_CLASS("_TtC20CryptoSavingsTracker10CacheEntry")
...
SWIFT_CLASS("_TtC20CryptoSavingsTracker22FamilyShareAppDelegate")
@interface FamilyShareAppDelegate : NSObject <UIApplicationDelegate>
...
SWIFT_CLASS("_TtC20CryptoSavingsTracker30FamilyShareSceneDelegateBridge")
@interface FamilyShareSceneDelegateBridge : NSObject <UIWindowSceneDelegate>
